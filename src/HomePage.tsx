...
import { 
  ...
  Cpu, Code, Workflow, Camera, Briefcase, PenTool
} from 'lucide-react';
      ...
      <nav className="fixed top-0 w-full z-40 bg-synth-bg/80 backdrop-blur-md border-b border-synth-cyan/30">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            />
            <div className="font-mono font-bold text-xl text-white tracking-tighter hidden sm:block">
          ...
          <div className="hidden md:flex gap-6 font-mono text-sm">
            <Link to="/audit" className="hover:text-synth-cyan transition-colors">FREE AUDIT</Link>
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 font-mono">
              ...
              <motion.a 
                ...
                className="px-8 py-4 border border-synth-cyan text-synth-cyan hover:bg-synth-cyan/10 transition-all flex items-center justify-center gap-2 hover-3d-glasses"
              >
                REVIEW RESEARCH
              </motion.a>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4 font-mono">
                <RetroWindow title="intelligence.sys">
                  <div className="text-synth-cyan mb-2">Google Gemini / NotebookLM / Antigravity</div>
                </RetroWindow>

                <RetroWindow title="nervous_system.exe">
                  <div className="text-synth-magenta mb-2">n8n, APIs, HubSpot, GA4, Clarity</div>
                </RetroWindow>
