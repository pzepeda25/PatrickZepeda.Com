...
// ⚡ Bolt: Wrapped in React.memo() to prevent its complex card stack layout
// logic and animations from re-evaluating when the parent App component's scroll state updates.
