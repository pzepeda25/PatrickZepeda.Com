...
import imageForgeImg from '@/src/assets/image-forge.png';
import dachshundChefImg from '@/src/assets/dachshund-chef.png';
import tvFishBowlImg from '@/src/assets/tv-fish-bowl.png';
import lakeCabinImg from '@/src/assets/lake-cabin.png';
