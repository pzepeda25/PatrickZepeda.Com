        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-synth-cyan/10 border border-synth-cyan/30 text-synth-cyan text-sm font-mono uppercase tracking-wider">
              ...
              <span>Patrick Zepeda · Featured work</span>
            </div>
            ...
            <p className="text-base md:text-lg font-mono text-synth-magenta/90 tracking-wide">
              Creative technologist · AI, product, and conversion-minded builds
            </p>
            
            <div className="space-y-4">
              <p className="text-lg lg:text-xl text-gray-300 font-light leading-relaxed">
                This site is my home base—the through-line is how I design and ship: tight UX, honest narrative, and tooling that holds up under real use. Below is one live build I ship and iterate on—a structured prompt lab that exports production-ready configs (including JSON) so teams can move faster without sacrificing control.
              </p>
              <div className="flex flex-wrap gap-2 pt-2">
                {['Creative technology', 'AI product', 'Systems & UX'].map(skill => (
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 pt-4">
              ...
              >
                ...
                <span className="relative z-10">Open live build</span>
              ...
              <div className="flex items-center justify-center gap-3 px-8 py-4 border border-synth-purple/30 bg-synth-purple/5 rounded-sm w-full sm:w-auto">
                ...
                <span className="text-gray-300 font-mono text-sm uppercase tracking-wider">Exports include structured JSON for your stack</span>
              </div>
            </div>
          </motion.div>
            ...
            >
              ...
              <div className="relative rounded-xl overflow-hidden border-2 border-synth-cyan/50 shadow-[0_0_30px_rgba(0,0,0,0.4)] lg:shadow-[0_0_50px_rgba(0,0,0,0.6)] bg-synth-darker">
                <div className="h-6 lg:h-8 bg-black/80 border-b border-synth-cyan/30 flex items-center px-3 lg:px-4 gap-1.5 lg:gap-2">
                  ...
                  <div className="mx-auto text-[10px] lg:text-xs font-mono text-synth-cyan/70 tracking-widest">Live project preview</div>
                </div>
                <div className="relative aspect-[16/9] bg-synth-dark flex items-center justify-center overflow-hidden">
                   <img src="/xml-image-forge/main-image-forge.webp" alt="Patrick Zepeda — featured build interface preview" className="w-full h-full object-cover opacity-90 lg:opacity-80 group-hover:opacity-100 transition-opacity duration-500" onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1618477388954-7852f32655ec?q=80&w=1000&auto=format&fit=crop"; e.currentTarget.classList.add('opacity-40'); }} />
