        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 pt-4">
              <a 
                ...
                className="retro-key group relative inline-flex items-center justify-center gap-2 px-10 py-4 bg-synth-cyan text-black font-black uppercase tracking-widest overflow-hidden rounded-sm transition-all w-full sm:w-auto"
              >
          ...
          <div className="w-full lg:w-1/2 relative lg:min-h-[600px] mt-8 lg:mt-0 flex flex-col gap-4 lg:block">
            ...
            >
              ...
              <div className="xml-forge-frame relative overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.4)] lg:shadow-[0_0_50px_rgba(0,0,0,0.6)] bg-synth-darker">
                ...
                <div className="relative aspect-[3/2] bg-synth-dark flex items-center justify-center overflow-hidden">
            ...
            <div className="grid grid-cols-3 gap-3 lg:block">
              ...
              >
                <div className="xml-forge-frame relative overflow-hidden shadow-lg lg:shadow-[0_20px_40px_rgba(0,0,0,0.8)] transition-all duration-500">
            ...
            <div className="xml-workflow-icons hidden lg:flex" aria-hidden="true">
              <div className="xml-workflow-icon">
                <Code className="w-5 h-5" strokeWidth={1.4} />
                <span>structure</span>
              </div>
              <div className="xml-workflow-icon">
              ...
              <div className="xml-workflow-icon">
                <ExternalLink className="w-5 h-5" strokeWidth={1.4} />
                <span>ship</span>
              </div>
            </div>
